    ...
    <div class="container-fluid justify-content-center">
        <div class="row mt-5" id="productCardSection">
            <?php foreach ($data as $i) { ?>
                <div class="col-sm-3">
                    <div class="card"> <img src="<?=$i['product_image']?>?alt=media" class="card-img-top img-fluid img-thumbnail"  style="width: 300px; height: 300px; object-fit:cover;" >
                        <div class="card-body pt-0 px-0">
                            ...
                            <div class="d-flex flex-row justify-content-between mb-0 mt-3 px-3"> <span class="text-muted mt-1">Starting At:</span>
                                <h6>Rp.<?= number_format($i['starting_price']) ?></h6>
                            </div>
                            <hr class="mt-2 mx-3">
                            <div class="d-flex flex-row justify-content-between px-3 pb-2">
                                ...
                                <div class="d-flex flex-column">
                                    <h6>Rp.<?= number_format($i['highest_bid']) ?></h6>
                                </div>
                            </div>
                            <div class="d-flex flex-row justify-content-between px-3 pb-2">
