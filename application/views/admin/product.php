                        ...
                        <div class="card-header">
                            <h5 class="m-0 text-dark">Product List
                                <div class="float-right">
                                    <a href="<?= base_url() ?>product/syncproductbid"  onclick="return confirm('This Button will run function to validate all product and send the notification. Are you sure?');" class="btn btn-sm btn-warning"><i class="fa fa-sync"></i> Validate Products</a>
                                </div>
                            </h5>
                        </div>
                        <div class="card-body">
